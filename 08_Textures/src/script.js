...
//Textures
/** //! Alternative way to load textures
 * const doorTexture = new THREE.Texture();

const image = new Image();
image.src = '../static/textures/door/color.jpg';

image.onload = () => {
  doorTexture.image = image;
  doorTexture.needsUpdate = true; 

  // Once loaded, create your cube
...
const ambientOcclusionTexture = textureLoader. load('/textures/door/ambientcclusion.jpg')
